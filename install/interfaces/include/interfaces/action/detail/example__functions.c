...
interfaces__action__Example_Goal__are_equal(const interfaces__action__Example_Goal * lhs, const interfaces__action__Example_Goal * rhs)
{
  ...
  // morning
  if (lhs->morning != rhs->morning) {
    return false;
  }
  // cheery
  if (lhs->cheery != rhs->cheery) {
    return false;
  }
  return true;
}
  ...
  interfaces__action__Example_Goal * output)
{
  ...
  // morning
  output->morning = input->morning;
  // cheery
  output->cheery = input->cheery;
  return true;
}
  ...
  interfaces__action__Example_Goal__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    ...
    interfaces__action__Example_Goal * data =
      (interfaces__action__Example_Goal *)realloc(output->data, allocation_size);
    if (!data) {
      return false;
    }
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!interfaces__action__Example_Goal__init(&data[i])) {
        /* free currently allocated and return false */
        for (; i-- > output->capacity; ) {
          interfaces__action__Example_Goal__fini(&data[i]);
        }
        free(data);
        return false;
      }
  ...
  interfaces__action__Example_Result__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    ...
    interfaces__action__Example_Result * data =
      (interfaces__action__Example_Result *)realloc(output->data, allocation_size);
    if (!data) {
      return false;
    }
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!interfaces__action__Example_Result__init(&data[i])) {
        /* free currently allocated and return false */
        for (; i-- > output->capacity; ) {
          interfaces__action__Example_Result__fini(&data[i]);
        }
        free(data);
        return false;
      }
  ...
  interfaces__action__Example_Feedback__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    ...
    interfaces__action__Example_Feedback * data =
      (interfaces__action__Example_Feedback *)realloc(output->data, allocation_size);
    if (!data) {
      return false;
    }
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!interfaces__action__Example_Feedback__init(&data[i])) {
        /* free currently allocated and return false */
        for (; i-- > output->capacity; ) {
          interfaces__action__Example_Feedback__fini(&data[i]);
        }
        free(data);
        return false;
      }
  ...
  interfaces__action__Example_SendGoal_Request__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    ...
    interfaces__action__Example_SendGoal_Request * data =
      (interfaces__action__Example_SendGoal_Request *)realloc(output->data, allocation_size);
    if (!data) {
      return false;
    }
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!interfaces__action__Example_SendGoal_Request__init(&data[i])) {
        /* free currently allocated and return false */
        for (; i-- > output->capacity; ) {
          interfaces__action__Example_SendGoal_Request__fini(&data[i]);
        }
        free(data);
        return false;
      }
  ...
  interfaces__action__Example_SendGoal_Response__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    ...
    interfaces__action__Example_SendGoal_Response * data =
      (interfaces__action__Example_SendGoal_Response *)realloc(output->data, allocation_size);
    if (!data) {
      return false;
    }
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!interfaces__action__Example_SendGoal_Response__init(&data[i])) {
        /* free currently allocated and return false */
        for (; i-- > output->capacity; ) {
          interfaces__action__Example_SendGoal_Response__fini(&data[i]);
        }
        free(data);
        return false;
      }
  ...
  interfaces__action__Example_GetResult_Request__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    ...
    interfaces__action__Example_GetResult_Request * data =
      (interfaces__action__Example_GetResult_Request *)realloc(output->data, allocation_size);
    if (!data) {
      return false;
    }
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!interfaces__action__Example_GetResult_Request__init(&data[i])) {
        /* free currently allocated and return false */
        for (; i-- > output->capacity; ) {
          interfaces__action__Example_GetResult_Request__fini(&data[i]);
        }
        free(data);
        return false;
      }
  ...
  interfaces__action__Example_GetResult_Response__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    ...
    interfaces__action__Example_GetResult_Response * data =
      (interfaces__action__Example_GetResult_Response *)realloc(output->data, allocation_size);
    if (!data) {
      return false;
    }
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!interfaces__action__Example_GetResult_Response__init(&data[i])) {
        /* free currently allocated and return false */
        for (; i-- > output->capacity; ) {
          interfaces__action__Example_GetResult_Response__fini(&data[i]);
        }
        free(data);
        return false;
      }
  ...
  interfaces__action__Example_FeedbackMessage__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    ...
    interfaces__action__Example_FeedbackMessage * data =
      (interfaces__action__Example_FeedbackMessage *)realloc(output->data, allocation_size);
    if (!data) {
      return false;
    }
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!interfaces__action__Example_FeedbackMessage__init(&data[i])) {
        /* free currently allocated and return false */
        for (; i-- > output->capacity; ) {
          interfaces__action__Example_FeedbackMessage__fini(&data[i]);
        }
        free(data);
        return false;
      }
